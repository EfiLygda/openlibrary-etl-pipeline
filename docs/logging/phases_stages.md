...
| Stage                                     | Description                                                                                                                                                                                                                                 |
|-------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `FETCH_WORKS`                             | Retrieve work records (endpoint: [`SEARCH`](../api/entrypoints.md#search))                                                                                                                                                                  |
| `EXPORT_KEYS`                             | Export entity keys for downstream extraction                                                                                                                                                                                                |
| `FETCH_WORKS_AUTHORS_SERIES`              | Retrieve work, author, and series metadata (endpoint: [`WORKS`](../api/entrypoints.md#works), [`AUTHORS`](../api/entrypoints.md#authors-1), [`SERIES`](../api/entrypoints.md#series-1) via [`GET_MANY`](../api/entrypoints.md#get_many))    |
| `EXPORT_AUTHOR_KEY_NAMES`                 | Export author identifiers and names (endpoint: redirection via [`AUTHORS`](../api/entrypoints.md#authors-1))                                                                                                                                |
| `FETCH_BOOKS_VIA_WORK_KEY`                | Retrieve edition records for works (endpoint: [`SEARCH_EDITIONS_VIA_WORK_KEY`](../api/entrypoints.md#search_editions_via_work_key))                                                                                                         |
| `EXPORT_PUBLISHERS_SUBJECTS_PEOPLE_TIMES` | Export dimension entities from extracted records                                                                                                                                                                                            |
| `FETCH_AUTHOR_STATISTICS`                 | Retrieve author statistics  (endpoint: [`SEARCH_AUTHORS`](../api/entrypoints.md#search_authors))                                                                                                                                            |
| `FETCH_WORKS_RATINGS`                     | Retrieve work ratings (endpoint: [`WORKS_RATINGS`](../api/entrypoints.md#works_ratings))                                                                                                                                                    |
